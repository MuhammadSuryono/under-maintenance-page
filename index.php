...
<html lang="en">
<head>
	<title>PPDB - Under Construction</title>
	<meta charset="UTF-8">
	...
	<div class="bg-g1 size1 flex-w flex-col-c-sb p-l-15 p-r-15 p-t-55 p-b-35 respon1">
		...
		<div class="flex-col-c p-t-50 p-b-50">
			...
			<p class="txt-center l1-txt2 p-b-60">
				Laman PPDB Masih dalam perbaikan
			</p>
		...
		<span class="s1-txt3 txt-center">
			@ <span id="current-year"></span> Coming Soon Template. Designed by Colorlib
		</span>
...
<!--===============================================================================================-->
	...
	<script type="module" src="vendor/custome.js"></script>
